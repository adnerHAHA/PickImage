...
import com.fkl.pickimage.fragment.BaseFragment;
import com.fkl.pickimage.R;
import com.fkl.pickimage.utils.ReflectionUtil;
...
public abstract class UIView extends AppCompatActivity {
    ...
    public void setToolBar(int toolBarId, ToolBarOptions options) {
        ...
        toolbar.setBackgroundColor(getResources().getColor(R.color.search_bar_background));
