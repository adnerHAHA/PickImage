...
import com.fkl.pickimage.utils.RotateImageViewAware;
import com.fkl.pickimage.utils.ScreenUtil;
import com.fkl.pickimage.utils.ThumbnailsUtil;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (photoInfo != null) {
			...
			PickerImageLoadTool.disPlay(thumbPath, new RotateImageViewAware(viewHolder.image, photoInfo.getAbsolutePath()),
					R.drawable.image_download_failed);
		}
