...
import com.fkl.pickimage.fragment.PickerAlbumFragment;
import com.fkl.pickimage.fragment.PickerImageFragment;
import com.fkl.pickimage.model.AlbumInfo;
...
import com.fkl.pickimage.utils.PickerConfig;
import com.fkl.pickimage.utils.PickerImageLoadTool;
...
public class PickerAlbumActivity extends UIView implements PickerAlbumFragment.OnAlbumItemClickListener,
	...
	public void OnAlbumItemClick(AlbumInfo info) {
		...
		for (PhotoInfo photo : photoList) {
			//Log.e("*****", "OnAlbumItemClick: "+photo.getAbsolutePath() );
