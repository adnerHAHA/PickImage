...
import com.fkl.pickimage.adapter.PickerPreviewPagerAdapter;
import com.fkl.pickimage.model.PhotoInfo;
import com.fkl.pickimage.model.PickerContract;
import com.fkl.pickimage.utils.BitmapDecoder;
import com.fkl.pickimage.utils.Extras;
import com.fkl.pickimage.utils.ImageUtil;
import com.fkl.pickimage.utils.PickerUtil;
import com.fkl.pickimage.utils.RequestCode;
import com.fkl.pickimage.view.BaseZoomableImageView;
import com.fkl.pickimage.view.ToolBarOptions;
import com.fkl.pickimage.view.UIView;
import com.fkl.pickimage.view.ViewPagerFixed;
...
public class PickerAlbumPreviewActivity extends UIView implements OnClickListener, OnPageChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
       // HideSystemToolBar.getNavigationBarHeight(this);
       // HideSystemToolBar.changeToolBarColor(this,getResources().getColor(R.color.search_bar_background));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.picker_image_preview_photos_select) {
            ...
            if (selectPhotoList != null && selectPhotoList.size() == 0) {
                ...
                Toast.makeText(this, R.string.tip_choose_one_at_least, Toast.LENGTH_SHORT).show();
                //ToastUtil.shortToast(PickerAlbumPreviewActivity.this, getString(R.string.tip_choose_one_at_least));
            }else {
